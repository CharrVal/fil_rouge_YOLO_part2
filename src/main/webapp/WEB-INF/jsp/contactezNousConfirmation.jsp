...
<body>
	...
	<div class="container mt-5 text-center">
	    <div class="alert alert-success" role="alert">
	        <p class="lead">Merci pour votre message !</p>
	    </div>
	    
	    <div class="card mt-4">
	        <div class="card-body">
	            <h5 class="card-title">Bonjour,</h5>
	            <p class="card-text">Nous avons bien reçu votre message et notre équipe revient vers vous dès que possible pour vous répondre.</p>
	            <p class="card-text">Nous vous remercions de votre intérêt pour ${restaurant.nom}.</p>
	            <p class="card-text">Cordialement,</p>
	            <p class="card-text"><strong>L'équipe Pizza YOLO</strong></p>
	        </div>
	    </div>
	 </div>
